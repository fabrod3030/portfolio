    ...
    return (
        <main className="bg-green-100 min-h-screen p12">
            <section className="container mx-auto">
                ...
                <h2 className="text-lg text-gray-600 flex justity-center mb-12">Welcome to my page of blog post</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <article>
                        ...
                        <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-green-400" Key={index}>
                            <img src={post.mainImage.asset.url} alt="blog" className="w-full h-full rounded-r object-cover absolute"/>
